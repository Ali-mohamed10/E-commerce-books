import{j as e,e as a}from"./index-C5BbBdTb.js";const r=()=>e.jsx(t,{children:e.jsxs("div",{className:"main_wrapper",children:[e.jsxs("div",{className:"main",children:[e.jsxs("div",{className:"antenna",children:[e.jsx("div",{className:"antenna_shadow"}),e.jsx("div",{className:"a1"}),e.jsx("div",{className:"a1d"}),e.jsx("div",{className:"a2"}),e.jsx("div",{className:"a2d"}),e.jsx("div",{className:"a_base"})]}),e.jsxs("div",{className:"tv",children:[e.jsx("div",{className:"cruve",children:e.jsx("svg",{className:"curve_svg",version:"1.1",xmlns:"http://www.w3.org/2000/svg",xmlnsXlink:"http://www.w3.org/1999/xlink",viewBox:"0 0 189.929 189.929",xmlSpace:"preserve",children:e.jsx("path",{d:`M70.343,70.343c-30.554,30.553-44.806,72.7-39.102,115.635l-29.738,3.951C-5.442,137.659,11.917,86.34,49.129,49.13\r
  ...
  .tv {
    ...
    box-shadow: inset 0.2em 0.2em var(--color-second);
  }
  .tv::after {
    content: "";
    position: absolute;
    ...
    background: repeating-radial-gradient(
          var(--color-main) 0 0.0001%,
          #00000070 0 0.0002%
        )
        50% 0/2500px 2500px,
      repeating-conic-gradient(var(--color-main) 0 0.0001%, #00000070 0 0.0002%)
        60% 60%/2500px 2500px;
  ...
  .display_div {
    ...
    justify-content: center;
    border-radius: 15px;
    box-shadow: 3.5px 3.5px 0px var(--color-second);
  }
  .screen_out {
    width: auto;
    height: auto;
  ...
  .buttons_div {
    ...
    flex-direction: column;
    row-gap: 0.75em;
    box-shadow: 3px 3px 0px var(--color-second);
  }
  .b1 {
    width: 1.65em;
    height: 1.65em;
